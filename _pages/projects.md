...
In my first year as a PhD student, I worked on a mutational histories tracking tool that did not necessarily produce results (as first-year projects are wont to do), but did add a nice mutational history tracking tool to genomes in [MABE][https://github.com/Hintzelab/MABE].

In a past life, I worked as an undergraduate researcher in vertebrate morphology in [Dr. L. Patricia Hernandez's lab][https://biology.columbian.gwu.edu/patricia-hernandez] at George Washington University. There, I looked at how the shape of cypriniform (carp, minnow, etc.) pharyngeal jaws was (or wasn't!) related to phylogeny and function. 